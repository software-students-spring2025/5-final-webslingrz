...
async def main():
    try:
        ...
        common_click_sound = mixer.Sound("static/marimba-bloop-3-188151.mp3") 
        uncommon_click_sound = mixer.Sound("static/marimba-bloop-1-188150.mp3") 
        rare_click_sound = mixer.Sound("static/marimba-bloop-2-188149.mp3") 
        epic_click_sound = mixer.Sound("static/marimba-ringtone-2-185153.mp3") 
        legendary_click_sound = mixer.Sound("static/marimba-win-h-3-209697.mp3") 
        button_click_sound = mixer.Sound("static/107136__bubaproducer__button-18.wav")
        deco_click_sound = mixer.Sound("static/infographic-pop-4-197870.mp3")
